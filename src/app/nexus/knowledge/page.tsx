...
function CategoryCard({ category }: { category: KnowledgeCategory }) {
  ...
  return (
    <div className="nexus-card p-5 hover:border-[rgba(201,162,39,0.15)] transition-all duration-200 group">
  ...
  return (
    <div className="p-4 lg:p-6 min-h-full nexus-grid-bg">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          <h1 className="nexus-section-title text-2xl">Knowledge Base</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
        <div className="nexus-metric">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="nexus-metric-label" style={{ margin: 0 }}>Total Docs</span>
          </div>
          <div className="nexus-metric-value text-xl">{totalDocs}</div>
        </div>
        <div className="nexus-metric">
          <div className="flex items-center gap-2 mb-2">
            <Layers size={14} className="text-[#60A5FA]" />
            <span className="nexus-metric-label" style={{ margin: 0 }}>Categorias</span>
          </div>
          <div className="nexus-metric-value text-xl" style={{ color: "#60A5FA" }}>{CATEGORIES.length}</div>
        </div>
        <div className="nexus-metric">
          <div className="flex items-center gap-2 mb-2">
            <Clock size={14} className="text-[#34D399]" />
            <span className="nexus-metric-label" style={{ margin: 0 }}>Última Edição</span>
          </div>
          <div className="nexus-metric-value text-xl text-[#34D399]">Hoje</div>
        </div>
      </div>
